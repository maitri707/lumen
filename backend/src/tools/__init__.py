...
from .anatomy_3d import rotate_model, toggle_structure, hide_3d, reset_3d_view, set_camera_view, zoom_in, zoom_out
...
TOOL_REGISTRY = {
    ...
    "reset_3d_view": reset_3d_view, "set_camera_view": set_camera_view, "zoom_in": zoom_in, "zoom_out": zoom_out,
