...
from .patient_data import display_patient_data, display_all_patient_data, hide_patient_data, get_patient
from .ct_imaging import navigate_ct, jump_to_landmark, hide_ct
from .anatomy_3d import rotate_model, toggle_structure, hide_3d, reset_3d_view
...
TOOL_REGISTRY = {
    ...
    "hide_patient_data": hide_patient_data, "navigate_ct": navigate_ct, "jump_to_landmark": jump_to_landmark,
    "hide_ct": hide_ct, "rotate_model": rotate_model, "toggle_structure": toggle_structure, "hide_3d": hide_3d,
    "reset_3d_view": reset_3d_view, "get_surgical_phase": get_surgical_phase, "get_who_checklist": get_who_checklist,
